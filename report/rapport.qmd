...
Exécutons le module de nettoyage :

```python
#| label: wrangling-execution
#| echo: true
import os
import sys
sys.path.append(os.path.abspath('..'))

# TODO: Importer votre package de nettoyage 'src.data_clean'
# TODO: Charger le fichier raw_sensor_traffic.csv, uniformiser les dates,
# éliminer les outliers et imputer les valeurs manquantes à l'aide de vos fonctions.
```
...
#| echo: true
# TODO: Appliquer votre ingénierie de variables temporelles sur votre jeu de données propre
```
